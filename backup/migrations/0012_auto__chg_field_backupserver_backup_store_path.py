...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BackupServer.backup_store_path'
        db.alter_column('backup_backupserver', 'backup_store_path', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'BackupServer.backup_store_path'
        db.alter_column('backup_backupserver', 'backup_store_path', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'backup.backupjob': {
            ...
            'next_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 23, 20, 43, 45, 634413)', 'null': 'True', 'blank': 'True'}),
        ...
        'backup.backupserver': {
            ...
            'backup_store_path': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
