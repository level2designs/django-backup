...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BackupServer.username'
        db.add_column('backup_backupserver', 'username', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BackupServer.username'
        db.delete_column('backup_backupserver', 'username')
    ...
    models = {
        ...
        'backup.backupjob': {
            ...
            'next_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 23, 20, 38, 3, 219770)', 'null': 'True', 'blank': 'True'}),
