...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BackupServer.backup_store_path'
        db.add_column('backup_backupserver', 'backup_store_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BackupServer.backup_store_path'
        db.delete_column('backup_backupserver', 'backup_store_path')
    ...
    models = {
        ...
        'backup.backupjob': {
            ...
            'next_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 23, 20, 42, 49, 204963)', 'null': 'True', 'blank': 'True'}),
