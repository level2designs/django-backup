...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.database_dump_path'
        db.add_column('backup_client', 'database_dump_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'BackupJob.database_dump_path'
        db.delete_column('backup_backupjob', 'database_dump_path')


    def backwards(self, orm):
        
        # Deleting field 'Client.database_dump_path'
        db.delete_column('backup_client', 'database_dump_path')

        # Adding field 'BackupJob.database_dump_path'
        db.add_column('backup_backupjob', 'database_dump_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'backup.backupjob': {
            ...
            'next_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 27, 20, 52, 40, 305877)', 'null': 'True', 'blank': 'True'}),
