...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BackupJob.username'
        db.add_column('backup_backupjob', 'username', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Database.username'
        db.add_column('backup_database', 'username', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Database.password'
        db.add_column('backup_database', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BackupJob.username'
        db.delete_column('backup_backupjob', 'username')

        # Deleting field 'Database.username'
        db.delete_column('backup_database', 'username')

        # Deleting field 'Database.password'
        db.delete_column('backup_database', 'password')
    ...
    models = {
        ...
        'backup.backupjob': {
            ...
            'next_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 23, 19, 59, 10, 79781)', 'null': 'True', 'blank': 'True'}),
