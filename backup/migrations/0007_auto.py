...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field directories on 'BackupJob'
        db.create_table('backup_backupjob_directories', (
        ...
        db.create_unique('backup_backupjob_directories', ['backupjob_id', 'directory_id'])

        # Adding M2M table for field databases on 'BackupJob'
        db.create_table('backup_backupjob_databases', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('backupjob', models.ForeignKey(orm['backup.backupjob'], null=False)),
            ('database', models.ForeignKey(orm['backup.database'], null=False))
        ))
        db.create_unique('backup_backupjob_databases', ['backupjob_id', 'database_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field directories on 'BackupJob'
        db.delete_table('backup_backupjob_directories')

        # Removing M2M table for field databases on 'BackupJob'
        db.delete_table('backup_backupjob_databases')
    ...
    models = {
        ...
        'backup.backupjob': {
            ...
            'next_run': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 23, 21, 56, 58, 381179)', 'null': 'True', 'blank': 'True'}),
